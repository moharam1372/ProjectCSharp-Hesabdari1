...
{
    public partial class Date_Samim : UserControl
    {
        ...
        public Date_Samim()
        {
            ...
            _clsFontBold.ChangeFont(Cmb_Day,13);
            _clsFontBold.ChangeFont(Cmb_Year,13);
            _clsFontBold.ChangeFont(Cmb_Month,13);
            //try
            //{
            //    Class_Text.ChangeFont(Cmb_Year);
            //    Class_Text.ChangeFont(Cmb_Month);
            //    Class_Text.ChangeFont(Cmb_Day);
            //}
            //catch
            //{
            //    // ignored
        ...
        {
            Cmb_Day.Text = CC1.T_Day();
            Cmb_Month.Text = CC1.T_Month();
            Cmb_Year.Text = CC1.T_Year();
            Date_IR = Cmb_Year.Text + "/" + Cmb_Month.Text + "/" + Cmb_Day.Text;
            //Fun_DateUS();
        }
        ...
        {
            // MessageBox.Show(Cmb_Year.Text);
            if (Cmb_Year.EditValue == "")
                Cmb_Year.Text = CC1.T_Year();

            if (Convert.ToInt32(Cmb_Year.EditValue) < 1380)
                Cmb_Year.Text = CC1.T_Year();

            if (Convert.ToInt32(Cmb_Year.EditValue) > 1600)
            {
                //MessageBox.Show(Convert.ToInt32(Cmb_Year.Text).ToString());
                Cmb_Year.Text = CC1.T_Year();
            }
            //  MessageBox.Show(Convert.ToInt32(Cmb_Year.Text).ToString());
            Load_Day();
        ...
        public DateTime Date_US()
        {
            return Shamsi_To_Miladi_Plus_Time(Date_IR);
        }
        public DateTime Date_US_NoTime()
        {
            return Shamsi_To_Miladi_No_Time(Date_IR);
        }
